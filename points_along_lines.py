...
from .points_along_lines_dialog import PointsAlongLinesDialog
import os.path
import csv


class PointsAlongLines:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'PointsAlongLines_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Points Along Lines')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('PointsAlongLines', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/points_along_lines/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Points along lines'),
            callback=self.run,
    ...
    def select_csv_file(self):
        filename, _filter = QFileDialog.getOpenFileName(
            self.dlg, 'Select output file','Z:/16-MATR/16-482-91/GIS/cctv wye locations test/cctv_log.csv', '*.csv')
    ...
    def get_point_geometry(self, pid, dist, direction):
        ...
        for feature in selection:
            ...
            pt = feature.geometry().interpolate(dist)
        return pt, length_error
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = PointsAlongLinesDialog()
